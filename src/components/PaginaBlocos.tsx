      ...
      case "hero_banner":
        return (
          <section key={bloco.id} className={fullBleedTop ? `${FULL_BLEED} bg-[#07090e]` : "relative overflow-hidden rounded-[2rem] bg-[#07090e]"}>
            {campos.imagem ? (
              <div className="relative w-full sm:aspect-[21/9] sm:min-h-[320px]">
                <BlocoImg src={campos.imagem} alt={campos.imagemAlt || ""} className="w-full h-auto sm:absolute sm:inset-0 sm:h-full sm:object-cover sm:object-top" />
                {!coverSemTexto && (
                  <>
